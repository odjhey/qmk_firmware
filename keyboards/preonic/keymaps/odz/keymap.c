...
[_QWERTY] = LAYOUT_preonic_grid(
  LT(_NAV, KC_GRV),  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, LT(_LOWER, KC_MINS),
  ...
  KC_LCTL, LOWER,  RAISE, KC_LALT, KC_SPC,  LGUI_T(KC_BSPC), LT(_RAISE, KC_ENT),  KC_SPC,  KC_RALT, KC_DEL, KC_RCTL, RAISE
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, KC_DEL,  KC_INS,  KC_LBRC, KC_RBRC, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, KC_DEL,  _______, _______, _______, _______, _______, _______
),

[_NAV] = LAYOUT_preonic_grid(
  _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______,
  _______, _______, KC_LEFT, KC_RGHT, _______, _______,   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______, 
  _______, _______, KC_DOWN, KC_UP,   _______, _______,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, 
