...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, RAISE,  LOWER, KC_LALT, KC_SPC,  LGUI_T(KC_BSPC), LGUI_T(KC_ENT),  KC_SPC,   KC_EQUAL, KC_DEL, LOWER,  RAISE
),
...
[_LOWER] = LAYOUT_preonic_grid(
  RGB_TOG, RGB_MOD, _______,  _______, _______,  _______, _______, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
